...
#     # محاكاة سلوك torch
#     with patch('Jobs.news.torch.nn.functional.softmax', return_value=[[0.1, 0.8, 0.1]]) as mock_softmax, \
#          patch.object(mock_outputs.logits, 'argmax', return_value=1) as mock_argmax, \
...
#         # افترض أن التسميات هي ['negative', 'neutral', 'positive']
#         with patch('Jobs.news.sentiment_labels', ['negative', 'neutral', 'positive']):
...
#             mock_argmax.assert_called_once_with(dim=-1)
